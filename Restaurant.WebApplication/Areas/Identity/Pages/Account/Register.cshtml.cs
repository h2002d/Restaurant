        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    #region Custom action for customer save
                    //creating new customer object and filling in the info about customer
                    CustomerRepository repo = new CustomerRepository(_dbContext);
